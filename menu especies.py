...
for especies in db_especies:
    for especie in especies:
        ...
        especies_obj.append(Especies(especie['name'],especie['average_height'],especie['classification'],cargar_API(especie["homeworld"])['name'],especie['language'],lista_personajes,'pelicula')) #hay que arreglar lista de personas y pelicula
